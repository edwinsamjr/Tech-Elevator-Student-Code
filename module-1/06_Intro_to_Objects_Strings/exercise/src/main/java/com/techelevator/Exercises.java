...
//        boolean stringStartsWithBad = str.substring(0,3).equals("bad");
//        boolean stringBadAtIndexOne = str.substring(1,4).equals("bad");
    ...
    public boolean doubleX(String str) {
        boolean containsFirstXX = false;
        for (int i = 0; i < str.length() - 1; i++) {
            if (str.charAt(i) == 'x') {
                if (str.charAt(i + 1) == 'x') {
                    containsFirstXX = true;
                }
                break;
            }

        }
        return containsFirstXX;
    }
    ...
    public int last2(String str) {
        ...
        if (str.length() < 3) {
            ...
            String testString = str.substring(str.length() - 2, str.length());
            for (int i = 0; i < str.length() - 2; i++) {
                if (str.substring(i, i + 2).equals(testString)) {
                    counter++;
                }
            }
            return counter;
    ...
    public String stringX(String str) {
        ...
        if (str.length() < 3) {
            ...
            String finalString = middleString.replace("x", "");
            return str.substring(0, 1) + finalString + str.substring(str.length() - 1, str.length());
        }
    }
