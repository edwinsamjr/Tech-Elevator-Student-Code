...
public class ArrayUtilsTest {
    ...
    public void correct_value_returned_from_three_element_array() {
        ...
        //Assert
        Assert.assertEquals("Did not get expected max value",3, actual);
    ...
    public void correct_value_returned_with_all_negative_numbers() {
        ...
        //Assert
        Assert.assertEquals("Did not get expected max value",-1, actual);
    ...
    public void correct_value_returned_with_empty_array() {
        ...
        //Assert
        Assert.assertEquals("Did not get expected max value",Integer.MIN_VALUE, actual);
